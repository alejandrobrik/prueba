...
public class AuthService {
    ...
    public String register(String username, String password, String mail, String identificacion, String nombres, String apellidos, String fechaNacimiento) {
        // Verificar si el usuario o correo ya existen
        if (usuarioRepository.findByUsernameOrMail(username, mail).isPresent()) {
            return "Error: El nombre de usuario o correo ya están registrados.";
        }
        ...
        usuario.setStatus("activo");
        usuario.setIntentosFallidos(0);
        usuario.setPersona(persona);  // Asociamos la persona creada
        ...
        return "Usuario registrado exitosamente. " + response;
    }
}
